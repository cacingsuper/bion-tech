<div style="background-color: rgba(0,0,0,91%);" data-elementor-type="header" data-elementor-id="18" class="elementor elementor-18 elementor-location-header" data-elementor-settings="[]">
                                                        ...
                                                        <div class="elementor-element elementor-element-95c08e1 elementor-widget elementor-widget-image" data-id="95c08e1" data-element_type="widget" data-widget_type="image.default">
                                                            <div class="elementor-widget-container">
                                                                <div class="elementor-image">
                                                                    <a href="<?= base_url()?>">
                                                                        <img src="<?= base_url('logo.png') ?>" class="attachment-large size-large" alt="" loading="lazy" height="170" width="290" /> </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
